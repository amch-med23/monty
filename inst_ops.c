...
/**
 * inst_cmp - Function that compares instructions with the function pointers
 * @str1: String 1
 * @str2: String 2
 * Return: 0 on success and -1 otherwise
 */
int inst_cmp(char *str1, char *str2)
{
	int i = 0, n = 0;
...
/**
 * inst_crt - Function that creates a node in the list of opcode
